  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        />
        <p className="text-[var(--text-muted)]">Submit a CS 1.6 map for review</p>
        <p className="text-xs text-[var(--text-muted)] mt-1">Max 20 MB per file · Drop or click to browse</p>
      </div>
